  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3">
      ...
      <a
        ...
        className="w-14 h-14 sm:w-15 sm:h-15 bg-[#25d366] text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-200"
      >
        <svg className="w-8 h-8 sm:w-8.5 sm:h-8.5 fill-current" viewBox="0 0 24 24">
