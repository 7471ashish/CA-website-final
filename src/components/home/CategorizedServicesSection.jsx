...
export default function CategorizedServicesSection({ onOpenConsultation }) {
  ...
  // Continuous auto-movement (advances every 2.4 seconds, pauses instantly on hover)
  useEffect(() => {
    if (bizPaused) return;
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-10">
            <div className="text-center sm:text-left">
              ...
              <p className="text-xs sm:text-sm text-slate-600 mt-1">
                Fast incorporation &amp; statutory licensing across all legal structures (Center card zoomed in &bull; Hover to pause)
              </p>
            </div>
