...
export default function CategorizedServicesSection({ onOpenConsultation }) {
  ...
  // Auto transition with active continuous auto-sliding (2.8s interval)
  useEffect(() => {
    if (bizPaused) return;
  ...
  // Auto transition with active continuous auto-sliding (3.0s interval)
  useEffect(() => {
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-10">
            <div className="text-center sm:text-left">
              ...
              <p className="text-xs sm:text-sm text-slate-600 mt-1">
                Fast incorporation &amp; statutory licensing across all legal structures (Center card zoom-in spotlight)
              </p>
            </div>
