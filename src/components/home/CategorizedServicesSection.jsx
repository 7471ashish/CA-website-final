...
export default function CategorizedServicesSection({ onOpenConsultation }) {
  ...
  return (
    <div className="space-y-0 overflow-hidden">
      ...
      {/* SECTION 1: Business Registrations (Continuous Smooth Motion with Instant Pause on Hover) */}
      <section className="py-20 bg-[#f9fafb] text-slate-800 transition-colors duration-200 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-10">
            <div className="text-center sm:text-left">
              ...
              <p className="text-xs sm:text-sm text-slate-600 mt-1">
                Fast incorporation &amp; statutory licensing across all legal structures (Continuous movement &bull; Hover to pause)
              </p>
            </div>
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className="w-10 h-10 rounded-full bg-white border-2 border-slate-300 hover:border-[#55b848] text-slate-700 hover:text-emerald-700 shadow-sm flex items-center justify-center transition-all cursor-pointer hover:scale-105 active:scale-95"
                  title="Scroll Left"
                >
          ...
          {/* Continuous Infinite Horizontal Animated Track */}
          <div
            ref={scrollRef1}
            className="marquee-container overflow-x-auto no-scrollbar py-4"
          >
            <div className="animate-marquee-infinite flex gap-6 py-2">
              {[...businessRegistrations, ...businessRegistrations].map((item, idx) => {
                const Icon = item.icon;
                return (
                  <div
                    key={idx}
                    className="w-[280px] sm:w-[320px] bg-white rounded-3xl p-5 sm:p-6 border-2 border-slate-300 hover:border-[#55b848] shadow-sm hover:shadow-2xl hover:scale-105 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between text-center group shrink-0 relative z-10 hover:z-20 cursor-pointer"
                  >
                    <div>
                      <div className="w-14 h-14 mx-auto mb-3.5 rounded-2xl bg-emerald-50 border border-emerald-200 flex items-center justify-center text-[#2f8524] group-hover:scale-110 group-hover:bg-[#55b848] group-hover:text-white transition-all shadow-2xs">
                      ...
                      <p className="text-xs sm:text-[13px] text-slate-700 font-medium leading-relaxed mb-4 line-clamp-3">
                        {item.desc}
                      </p>
                    </div>
      ...
      {/* SECTION 2: Audit and Tax Management (Continuous Smooth Motion with Instant Pause on Hover) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-10">
            <div className="text-center sm:text-left">
              ...
              <p className="text-xs sm:text-sm text-slate-600 mt-1">
                Partner-led taxation strategy, statutory audits under ICAI standards &amp; MCA compliances (Hover to pause)
              </p>
            </div>
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className="w-10 h-10 rounded-full bg-white border-2 border-slate-300 hover:border-[#f37920] text-slate-700 hover:text-orange-700 shadow-sm flex items-center justify-center transition-all cursor-pointer hover:scale-105 active:scale-95"
                  title="Scroll Left"
                >
                  <ChevronLeft className="w-5 h-5" />
                </button>
          ...
          {/* Continuous Infinite Horizontal Animated Track (Reverse) */}
          <div
            ref={scrollRef2}
            className="marquee-container overflow-x-auto no-scrollbar py-4"
          >
            <div className="animate-marquee-reverse flex gap-6 py-2">
              {[...auditTaxServices, ...auditTaxServices].map((item, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="w-[280px] sm:w-[320px] bg-white rounded-3xl p-5 sm:p-6 border-2 border-slate-300 hover:border-[#f37920] shadow-sm hover:shadow-2xl hover:scale-105 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between text-center group shrink-0 relative z-10 hover:z-20 cursor-pointer"
                  >
                    <div>
                      <div className="w-14 h-14 mx-auto mb-3.5 rounded-2xl bg-orange-50 border border-orange-200 flex items-center justify-center text-[#d9630e] group-hover:scale-110 group-hover:bg-[#f37920] group-hover:text-white transition-all shadow-2xs">
                        <Icon className="w-7 h-7" />
                      </div>
