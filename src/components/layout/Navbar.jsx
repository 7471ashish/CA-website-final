...
export default function Navbar({ onOpenConsultation, onOpenSearch }) {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b-2 border-slate-200 shadow-sm transition-colors duration-200 w-full">
        <div className="w-full max-w-[1600px] mx-auto px-2 sm:px-3 lg:px-4 xl:px-6">
          <div className="flex items-center justify-between h-14 sm:h-16 lg:h-17 xl:h-19 w-full gap-1.5 sm:gap-2 lg:gap-2.5 xl:gap-5">
            
            {/* 1. BRAND LOGO (Left - Compact & Symmetrical) */}
            <Link to="/" className="flex items-center gap-1.5 sm:gap-2 shrink-0 group">
              ...
              <div className="flex flex-col items-center justify-center text-center whitespace-nowrap">
                ...
                <span className="inline-block text-[7px] sm:text-[8px] lg:text-[8.5px] xl:text-[9.5px] 2xl:text-[10.5px] font-black text-gold-600 uppercase tracking-[0.14em] sm:tracking-[0.16em] leading-none mt-0.5 bg-gold-50/80 px-1 py-0.5 rounded border border-gold-300/70 text-center">
            ...
            <nav className="hidden lg:flex items-center gap-1 lg:gap-1.5 xl:gap-3.5 2xl:gap-6 whitespace-nowrap">
              <NavLink to="/" className={navLinkClass}>
                Home
              </NavLink>

              {/* Start Business Mega Dropdown (Aligned Left-To-Right) */}
              <div
              ...
              >
                ...
                {activeDropdown === 'business' && (
                  <div className="absolute top-full left-0 xl:left-1/2 xl:-translate-x-1/2 w-[680px] xl:w-[780px] 2xl:w-[840px] max-w-[calc(100vw-2rem)] bg-white border-2 border-slate-200 rounded-3xl shadow-2xl p-5 sm:p-6 animate-fadeIn z-50 grid grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        <Link to="/company-incorporation" className="flex items-center gap-2 px-2 py-1 text-xs sm:text-[12.5px] font-bold text-slate-800 hover:text-[#102c4c] hover:bg-gold-50/70 rounded-lg transition-all">
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        <Link to="/gst-registration" className="flex items-center gap-2 px-2 py-1 text-xs sm:text-[12.5px] font-bold text-slate-800 hover:text-[#102c4c] hover:bg-gold-50/70 rounded-lg transition-all">
                          <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 shrink-0"></span>
                          <span>GST Registration (3-Day)</span>
                        </Link>
                        <Link to="/services" className="flex items-center gap-2 px-2 py-1 text-xs sm:text-[12.5px] font-bold text-slate-800 hover:text-[#102c4c] hover:bg-gold-50/70 rounded-lg transition-all">
                          <span className="w-1.5 h-1.5 rounded-full bg-gold-500 shrink-0"></span>
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        <Link to="/ngo-trust-registration" className="flex items-center gap-2 px-2 py-1 text-xs sm:text-[12.5px] font-bold text-slate-800 hover:text-[#102c4c] hover:bg-gold-50/70 rounded-lg transition-all">
                          <span className="w-1.5 h-1.5 rounded-full bg-gold-500 shrink-0"></span>
              ...
              {/* Compliances & Audit Mega Dropdown (Aligned Right-To-Left to stay 100% on screen) */}
              <div
                className="relative py-1"
              ...
              >
                ...
                {activeDropdown === 'audit' && (
                  <div className="absolute top-full right-0 xl:right-auto xl:left-1/2 xl:-translate-x-1/2 w-[680px] xl:w-[780px] 2xl:w-[840px] max-w-[calc(100vw-2rem)] bg-white border-2 border-slate-200 rounded-3xl shadow-2xl p-5 sm:p-6 animate-fadeIn z-50 grid grid-cols-3 gap-4">
                    {/* Sub-Service Category 1 */}
                    <div>
                      <div className="px-2 py-1 text-xs font-black uppercase tracking-wider text-gold-600 border-b-2 border-gold-200/80 mb-2.5 flex items-center gap-1.5">
                      ...
                      <div className="space-y-1">
                        <Link to="/itr-filing" className="flex items-center gap-2 px-2 py-1 text-xs sm:text-[12.5px] font-bold text-slate-800 hover:text-[#102c4c] hover:bg-gold-50/70 rounded-lg transition-all">
                          <span className="w-1.5 h-1.5 rounded-full bg-gold-500 shrink-0"></span>
                        ...
                        <Link to="/nri-taxation" className="flex items-center gap-2 px-2 py-1 text-xs sm:text-[12.5px] font-bold text-slate-800 hover:text-[#102c4c] hover:bg-gold-50/70 rounded-lg transition-all">
                          <span className="w-1.5 h-1.5 rounded-full bg-gold-500 shrink-0"></span>
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        <Link to="/audit-assurance" className="flex items-center gap-2 px-2 py-1 text-xs sm:text-[12.5px] font-bold text-slate-800 hover:text-[#102c4c] hover:bg-gold-50/70 rounded-lg transition-all">
                          <span className="w-1.5 h-1.5 rounded-full bg-gold-500 shrink-0"></span>
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        ...
                        <Link to="/networth-certificate" className="flex items-center gap-2 px-2 py-1 text-xs sm:text-[12.5px] font-bold text-slate-800 hover:text-[#102c4c] hover:bg-gold-50/70 rounded-lg transition-all">
                          <span className="w-1.5 h-1.5 rounded-full bg-gold-500 shrink-0"></span>
                          <span>Visa CA Networth Statement</span>
                        </Link>
                        <Link to="/project-financing-cma" className="flex items-center gap-2 px-2 py-1 text-xs sm:text-[12.5px] font-bold text-slate-800 hover:text-[#102c4c] hover:bg-gold-50/70 rounded-lg transition-all">
                          <span className="w-1.5 h-1.5 rounded-full bg-gold-500 shrink-0"></span>
                          <span>Bank CMA Data &amp; Project DPR</span>
                        </Link>
                        <Link to="/trademark-registration" className="flex items-center gap-2 px-2 py-1 text-xs sm:text-[12.5px] font-bold text-slate-800 hover:text-[#102c4c] hover:bg-gold-50/70 rounded-lg transition-all">
                          <span className="w-1.5 h-1.5 rounded-full bg-gold-500 shrink-0"></span>
