          ...
          <div className="fixed inset-y-0 right-0 max-w-xs w-full bg-white shadow-2xl p-6 overflow-y-auto flex flex-col justify-between">
            ...
            <div className="pt-6 border-t border-slate-200 space-y-3">
              <a
                ...
                className="w-full py-3 rounded-xl bg-[#25d366] text-white text-xs font-black flex items-center justify-center gap-2 shadow-md hover:brightness-105 transition-all"
              >
